...
def main(dataset_fraction=None):
    ...
    model_path_model = model_path + "/model"
    model_path_token = model_path + "/tokenizer"
    trainer.model.save_pretrained(model_path_model)
    trainer.tokenizer.save_pretrained(model_path_token)
